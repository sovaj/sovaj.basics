...
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.DB2;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.H2;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.HSQL;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.MYSQL;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.ORACLE;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.POSTGRESQL;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.SQL_SERVER;
import static io.sovaj.basics.test.dbunit.spring.DatabaseType.UNKNOWN;
