package org.sovaj.basics.test.dbunit.spring;

import static org.sovaj.basics.test.dbunit.spring.DatabaseType.DB2;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.H2;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.HSQL;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.MYSQL;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.ORACLE;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.POSTGRESQL;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.SQL_SERVER;
import static org.sovaj.basics.test.dbunit.spring.DatabaseType.UNKNOWN;
...
public class DatabaseUtils {
  ...
  public static String extractServerUrl(String url) {
    ...
    // If we have to add another exception to this for another database server, then I highly recommend refactoring this
