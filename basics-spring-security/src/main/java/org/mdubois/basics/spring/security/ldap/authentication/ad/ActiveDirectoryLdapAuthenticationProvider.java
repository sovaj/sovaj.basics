 ...
 */
package org.mdubois.basics.spring.security.ldap.authentication.ad;
...
//    }
    ...
    public ActiveDirectoryLdapAuthenticationProvider(String rootDn, String domain, String url) {
        ...
        this.rootDn = StringUtils.hasText(rootDn) ? rootDn : null;
    ...
    protected String createBindPrincipal(String username) {
